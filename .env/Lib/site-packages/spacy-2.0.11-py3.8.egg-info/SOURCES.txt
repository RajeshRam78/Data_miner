...
spacy/vocab.pxd
spacy/vocab.pyx
spacy.egg-info/PKG-INFO
spacy.egg-info/SOURCES.txt
spacy.egg-info/dependency_links.txt
spacy.egg-info/not-zip-safe
spacy.egg-info/requires.txt
spacy.egg-info/top_level.txt
spacy/syntax/_beam_utils.cpp
spacy/syntax/_state.cpp
spacy/syntax/arc_eager.cpp
spacy/syntax/ner.cpp
spacy/syntax/nn_parser.cpp
spacy/syntax/nonproj.cpp
spacy/syntax/stateclass.cpp
spacy/syntax/transition_system.cpp
spacy/tokens/_retokenize.cpp
spacy/tokens/doc.cpp
spacy/tokens/span.cpp
spacy/tokens/token.cpp
...
spacy/tests/doc/test_span_merge.py
spacy/tests/doc/test_token_api.py
spacy/tests/gold/__init__.py
...
spacy/tests/lang/en/test_ner.py
...
spacy/tests/lang/fr/test_lemmatization.py
...
spacy/tests/regression/__init__.py
spacy/tests/regression/test_issue118.py
...
spacy/tests/regression/test_issue1622.py
...
spacy/tests/regression/test_issue740.py
spacy/tests/regression/test_issue743.py
...
spacy/tests/regression/test_issue775.py
...
spacy/tests/regression/test_issue886.py
...
spacy/tests/serialize/test_serialize_parser_ner.py
spacy/tests/serialize/test_serialize_stringstore.py
...
spacy/tests/serialize/test_serialize_vocab.py
spacy/tests/stringstore/__init__.py
spacy/tests/stringstore/test_freeze_string_store.py
spacy/tests/stringstore/test_stringstore.py
spacy/tests/tokenizer/__init__.py
spacy/tests/tokenizer/sun.txt
...
spacy/tests/vectors/test_vectors.py
spacy/tests/vocab/__init__.py
spacy/tests/vocab/test_add_vectors.py
spacy/tests/vocab/test_lexeme.py
spacy/tests/vocab/test_vocab_api.py
